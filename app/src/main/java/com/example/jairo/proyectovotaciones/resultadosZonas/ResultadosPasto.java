...
public class ResultadosPasto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_pasto);
    ...
    private void obtenerListaPasto()
    {

        DatosOpenApiService service = retrofit.create(DatosOpenApiService.class);
        Call<ArrayList<VotacionPasto>> votacionRespuestaCall = service.obtenerListaPasto();
