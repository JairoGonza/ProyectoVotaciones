...
public class ResultadosGilberto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_gilberto);
    ...
    private void obtenerListaGilberto()
    {

        DatosOpenApiService service = retrofit.create(DatosOpenApiService.class);
        Call<ArrayList<VotacionPasto>> votacionRespuestaCall = service.obtenerListaGilberto();
