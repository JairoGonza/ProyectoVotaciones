...
public class ResultadosOscar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultados_oscar);
    ...
    private void obtenerListaOscar()
    {

        DatosOpenApiService service = retrofit.create(DatosOpenApiService.class);
        Call<ArrayList<VotacionPasto>> votacionRespuestaCall = service.obtenerListaOscar();
